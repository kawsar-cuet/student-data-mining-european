...
ax2.set_title('Area Under ROC Curve (AUC) Comparison', fontsize=13, fontweight='bold')
...
ax4.set_title('10-Fold Cross-Validation Mean Accuracy', fontsize=13, fontweight='bold')
