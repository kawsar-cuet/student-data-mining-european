...
ax1.set_title('(a) Class Distribution - Student Outcomes', fontsize=12, fontweight='bold', pad=15)

# Bar chart with counts - (b)
ax2 = axes[1]
...
ax2.set_title('(b) Class Distribution - Sample Counts', fontsize=12, fontweight='bold', pad=15)
ax2.grid(axis='y', alpha=0.3, linestyle='--')
